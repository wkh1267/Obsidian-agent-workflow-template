...
$message = "Uncommitted work remains at closeout; Claude will not auto-stage or auto-commit. Commit with explicit paths and scope separation, or leave the files intentionally uncommitted. Paths: $($sample -join ', ')$suffix"
